...
import com.pmh.tdc.timer.Util_Timer;

// Model kế thừa ứng dựng chạy Vbration - Calendar - Mediaplay
public class TimerModel extends Application {

	private Vibrator mVibrator; // rung
	private Calendar mCurrentAlarmCalendar; // lịch loại 24h
	private SharedPreferences mSettings; //
	private MediaPlayer mMediaPlayer; // âm thanh sử dụng MediaPlayer
	...
	public void startTimer(long milliseconds) {
		...
		Util_Timer.setAlarm(getApplicationContext(), 0, milliseconds,
				getNotificationAlarmTitle());
	}

	public void stopTimer() {
		Util_Timer.stopTimer(getApplicationContext());
	}
